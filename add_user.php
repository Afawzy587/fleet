        ...
        $groups        = $groups->getsitegroups();                                                           // groups
            ...
            }else
            {
                if($_POST)
                {
                    ...
                    $_user['users_birthday']                 =       sanitize($_POST["birthday"]);
                    $_user['users_hiring_date']              =       sanitize($_POST["hiring_date"]);
                    ...
                    $_user['users_license_expired']          =       sanitize($_POST["license_expired"]);
                    $_user['users_contract_finish']          =       sanitize($_POST["contract_end"]);
            ...
            <form class="addContactForm needs-validation" method="post" name="addContactForm" enctype="multipart/form-data" novalidate>
                <div class="row">
                    <div class="col white-bg mr-4 contact-header">
                        <div>
<!--                            <img class="rounded-circle" height="50" src="./profile-icon.png" alt="profile-pic">-->
                            <div class="contact-info">
<!--                                <h5>أحمد محمد</h5>-->
<!--                                <p class="tangerine">1125</p>-->
                            </div>
                        </div>
                        <div>
                            <button class="btn _btn btn-danger rose-bg mr-3"><?php echo $lang['CANCEL'];?></button>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="white-bg">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" name="name" required pattern="^[\u0600-\u065F\u066A-\u06EF\u06FA-\u06FFa-zA-Z]+[\u0600-\u065F\u066A-\u06EF\u06FA-\u06FFa-zA-Z-_]*$">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select  class="md-select custom-select" name="mangment" required>
                                            ...
                                            <?php
                                             ...
                                             {
                                                 echo '<option value="'.$v['management_sn'].'">'.$v['management_name'].'</option>';
                                             }
                                            ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select  class="md-select custom-select" name="job" required>
                                            ...
                                            <?php
                                             ...
                                             {
                                                 echo '<option value="'.$v['job_type_sn'].'">'.$v['job_type_name'].'</option>';
                                             }
                                            ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" name="qualification" required  maxlength="15">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="datepicker1" width="100%" name="birthday" required />
                                    </div>
                                    <div class="form-group">
                                        <label><?php echo $lang['HIRING_DATE'];?></label>
                                        <input id="datepicker2" width="100%" name="hiring_date" required />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="email" class="form-control"  autocomplete="new-password" name="email" required pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
                                            <div class="invalid-feedback">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="white-bg">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" name="serial" pattern="\d{1,4}" required maxlength="4">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" name="salary" required pattern="\d*">
                                            <div class="invalid-feedback">
                                                    أدخل أساسي الراتب مكون من أرقام فقط
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" name="bouns" required pattern="\d*">
                                            <div class="invalid-feedback">
                                                    أدخل البدلات السنوية مكونة من أرقام فقط
                                             </div>
                                        </div>
                                    </div>
<!--
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="white-bg">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" name="license_id" required pattern="\d{10}">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" name="licence_place" required maxlength="175">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="datepicker3" width="100%" name="license_expired" required />
                                    </div>
                                    <div class="form-group">
                                        <label><?php echo $lang['CONTRACT_END'];?></label>
                                        <input id="datepicker4" width="100%" name="contract_end" required />
                                    </div>
                                    <div class="form-group">
                                        <label><?php echo $lang['NOTES'];?> </label>
                                        <textarea name="notes" id="" rows="6" class="form-control custom-textarea-height"></textarea>
                                    </div>
                                    <div class="input-group attachement">
                            ...
                            <div class="col">
                                ...
                                <div class="white-bg bottom-contact-form">
                                    <div class="form-group col-md-4">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" name="user_name" autocomplete="new-password" required maxlength="25" >
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="group_id" id="" class="md-select" >
                                            ...
                                            <?php
                                              ...
                                              {
                                                  echo '<option value="'.$v['groups_sn'].'">'.$v['groups_name'].'</option>';
                                              }
                                            ?>
                                        </select>
                                    </div>
