...
//            $check           = intval($_GET['k']);
            ...
            if ($_POST)
            {
                ...
                $_back['back_car_id']                       =       intval($_POST["car"]);;
                $_back['back_car_supervisor_id']            =       intval($_POST["supervisor"]);
                $_back['back_car_driver_id']                =       intval($_POST["driver"]);
                $_back['back_car_delivery_by']              =       intval($_POST["delivery"]);
                $_back['back_car_kilos']                    =       sanitize($_POST["kilos"]);
                $_back['back_car_date']                     =       format_data_base(sanitize($_POST["date"]));
                $_back['back_car_time']                     =       sanitize($_POST["time"]);
                $_back['back_car_check_id']                 =       intval($_POST["check_id"]);
                $add = $cars->add_car_back($_back);
                if ($add == 1)
                {
...
<main class="">
       <div class="page_title d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center border-bottom">
        ...
        <div class="container page_body">
            ...
            <h5 class=" subtitle warning_status">(استلام من سائق) <?php echo $lang['ORDER_DETAILS'];?></h5>
            <div class="container page_body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" name="kilos" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo $lang['DATE_DELEVER'];?></label>
                                            <input id="datepicker2" width="100%" name="date" required />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo $lang['TIME_DELEVER'];?></label>
                                            <input id="timepicker2" width="100%" name="time" required />
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container page_body">
            <p class="small_title subtitle"><?php echo $lang['ORDER_DETAILS'];?></p>
            <h5 class=" subtitle darkish-green"> <?php echo $lang['DRIVER_RECIVE'];?> </h5>
            <div class="container page_body">
                <form action="" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                    <div class="row white-bg assign_to_driver">
                        <div class="col">
