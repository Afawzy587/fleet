            ...
            }else
            {
				...
				if ($mId != 0)
				{
					...
					if($_POST)
					{
						...
						$update = $fuels->setcar_fuelInformation($_fuel);
						if( $update == 1){
...
?>
    <main class="">
        ...
        <div class="container page_body">
            <div class="container page_body">
                <form method="post"  class="add_fuel_form" enctype="multipart/form-data" >
                    <div class="row">
                            ...
                            <div class="row ">
                                        ...
                                        <div class="col-xs-5">
                                            <select data-live-search="true" class=" selectpicker" name="car_code">
                                                <?php
                                                    ...
                                                    foreach($cars as $k => $c)
                                                    {
                                                        echo '<option value="'.$c['cars_sn'].'"';if($u['car_fuel_car_id'] == $c['cars_sn']){echo "selected";}echo'>'.$c['cars_code'].'</option>';
                                                    }
                                                ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-xs-5">
                                            <select data-live-search="true" class="form-control selectpicker" name="supervisor">
                                                <?php
                                                    ...
                                                    {
                                                        echo '<option value="'.$s['users_sn'].'"';if($u['car_fuel_by'] == $s['users_sn']){echo "selected";}echo'>'.$s['users_name'].'</option>';
                                                    }
                                                ?>
                                            </select>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-5">
                                            <input type="text" class="form-control small_input" name="prev_reading" value="<?php echo $u['car_fuel_previous_read'];?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-5">
                                            <input id="datepicker1" class="form-control" width="100%" name="date" autocomplete="off" value="<?php echo datepiker_format($u['car_fuel_date']);?>"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-5">
                                            <input id="timepicker1" class="form-control" width="100%" name="time" autocomplete="off" value="<?php echo $u['car_fuel_time'];?>"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-5">
                                            <input type="text" class="form-control small_input" name="current_reading" value="<?php echo $u['car_fuel_now_read'];?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row white-bg mt-1 ">
                        <div class="col-md-4 form-group">
                            <div class="custom-file col-xs-5">
                                ...
                                <?php if($u['car_fuel_counter_photo'] != "")echo'<p class="help-block"><a target="_blank" href="'.$path.$u['car_fuel_counter_photo'].'">'.$lang['SHOW_DAMAGE'].'</a></p>';?>
                            </div>
                        </div>
                        <div class="col-md-4 form-group">
                            <div class="custom-file col-xs-5">
                                ...
                                <?php if($u['car_fuel_pump_photo'] != "")echo'<p class="help-block"><a target="_blank" href="'.$path.$u['car_fuel_pump_photo'].'">'.$lang['SHOW_DAMAGE'].'</a></p>';?>
                                
                            </div>
                        </div>
                        <div class="col-md-4 form-group">
                            <div class="custom-file col-xs-5">
                                <input type="file" name="bill_image" class="custom-file-input" id="inputGroupFile02" aria-describedby="inputGroupFileAddon01">
                                <label class="custom-file-label" for="inputGroupFile02"><?php  echo $lang['INVOICE_IMAGE'];?></label>
                                  <?php if($u['car_fuel_invoice_photo'] != "")echo'<p class="help-block"><a target="_blank" href="'.$path.$u['car_fuel_invoice_photo'].'">'.$lang['SHOW_DAMAGE'].'</a></p>';?>
                    ...
                    <div class="row white-bg mt-1 flex_items_btween">
                                ...
                                <div class="col-xs-5">
                                    <select class="form-control md-select" name="fuel_type">
                                        <?php
                                            ...
                                            {
                                                echo '<option value="'.$t['fuel_type_sn'].'"';if($u['car_fuel_fuel_id'] == $t['fuel_type_sn']){echo "selected";}echo'>'.$t['fuel_type_name'].'</option>';
                                            }
                                        ?>
                                    </select>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-xs-5">
                                    <input type="text" class="form-control" name="station_name" maxlength="25" value="<?php echo $u['car_fuel_station'];?>" >
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row white-bg mt-1">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-xs-5">
                                    <input type="text" class="form-control" name="quantity" maxlength="25" value="<?php echo $u['car_fuel_amount'];?>">
                                </div>
                            </div>
                        </div>
                    </div>
