...
<main class="">
        <div
            ...
            <span class="page_titles">
                ...
                <h4 class="sub_title">
                    <strong> &gt; </strong>  <?php echo $lang['SERVICES'];?> </h4>
            </span>
            <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group mr-2">
                    <?php
                            ...
                            {
                                echo '<button class="btn dark_btn"><a href="./add_service_reminder.php">'.$lang['ADD_REMINDER'].'</a></button>';
                            }
                        ?>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                    <ul class="nav nav-tabs" role="tablist" id="myTab">
                        <li <?php if($page_name == "reminders"){echo "class='active'";}?>><a href="./reminders.php"><?php echo $lang['SERVICES'];?></a>
                        </li>
