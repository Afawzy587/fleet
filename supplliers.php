            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group mr-2">
                        <?php
                            ...
                            {
                                echo '<button class="btn dark_btn"><a href="./add-user.php">'.$lang['SU_ADD'].'</a></button>';
                            }
                        ?>
                </div>
            </div>
                ...
                <div class="col">
                    <ul class="nav nav-tabs" role="tablist" id="myTab">
                        <li <?php if($page_name == "suppliers"){echo "class='active'";}?>>
                            <a href="./suppliers.php"><?php echo $lang['CONT_TITLE'];?></a>
                        </li>
                        <li <?php if($page_name == "groups"){echo "class='active'";}?>>
                            <a href="./groups.php"><?php echo $lang['CONT_GROUPS'];?>
                            </a>
                        </li>
                        <li <?php if($page_name == "supplliers"){echo "class='active'";}?>>
                            <a href="./supplliers.php"><?php echo $lang['CONT_SUPLLIERS'];?></a>
                        </li>
                    </ul>
                                ...
                                <?php  if(empty($suppliers))
                                    {
                                        ...
                                        foreach($suppliers as $k => $u){
                                            echo'<tr id=tr_'.$u['suppliers_sn'].'>
                                                ...
                                                {
                                                   echo '<a href="./suplliers_edit.php"><i class="far fa-edit darkish-green"></i></a>';
                                                }
